...
前端显示基于easyui或layui两套前段框架，一键生成就可以直接使用包括新增修改删除等常规操作。
如果你使用了KenSite基础框架，就可以很高效的快速开发出，优秀的企业管理系统。
...
2. [帮助手册-环境搭建及开发简单介绍](http://www.seeyoui.com/2017/02/04/kensite-environment.html)
